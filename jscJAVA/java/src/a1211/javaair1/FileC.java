...
public class FileC { //그냥 파일 입출력 용? 전체 내용 복붙 받음. 시간 모자르다고.
        private FlightManger fm = new FlightManger();
        ...
        public void upload() {
            try{
                ...
                while((line = bufferedReader.readLine()) != null){
                    ...
                    FlightManger.getFlights().add(new Flight(flight[0],flight[1],Integer.parseInt(flight[2]),Boolean.parseBoolean(flight[3])));
                    //flights 리스트에 추가 
                }    
